        ...
        var result = {
            ...
            "ESTJ": {"animal": "'동기여서 다행이다'", "category":"당신의 유형은?", "explain_01": "성격은?", "img_01": "./img/DAN01.png", "img_02": "./img/bar_01.png", "explain_02":"관종끼 있어서 팀플 역햘은 무조건 발표맡으려고 함.", "explain_03": "항상 주도해서 본인이 원하는 방향으로 이끌어 내야 적성이 풀림.", "explain_04": "사실 그냥 혼자 다 맡아서 하는게 더 편함.", "explain_05": "계획적으로 움직임.", "explain_06": "옷 사지도 않을건데 옷사러 가고 이런거 안함. 남을 위해 시간 쓰는걸 싫어함." , "explain_07": "승부욕이 강해서 다른 사람보다 뒤처지면 부들부들함.", "explain_08": "아무리 친해도 일적으로 엮이면 같은 사람 맞나 싶음. 계획에 차질이 생기거나 불이익 당하면 불같이 화냄.", "explain02_aa":"잘맞는", "img02_aa": "./img/DAN01.png", "explain02_ab":"안맞는", "img02_ab": "./img/DAN01.png"}
        }
        var result02 = {
